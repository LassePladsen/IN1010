public class TestResepter {
    public static void main(String[] args) {
        BlaaResept blaa = new BlaaResept(new Vanlig("blaa", 15, 0.2),
                new Lege("test"), new Pasient("test", "00123013"), 10, 100);
        HvitResept hvit = new HvitResept(new Vanlig("hvit", 10, 0.5),
                new Lege("test2"), new Pasient("test", "00123013"), 11, 20);
        MilResept mil = new MilResept(new Vanlig("c", 1, 0.1),
                new Lege("test3"), new Pasient("test", "00123013"), 9);
        PResept p = new PResept(new Vanlig("p", 2, 0.45), new Lege("test4"),
        ...
        assert (mil.hentId() == 2)
                : "Feil id i militaer resept: " + mil.hentId();
